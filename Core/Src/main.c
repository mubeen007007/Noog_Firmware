...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED1_R_Pin|LED1_G_Pin|LED1_B_Pin|LED2_R_Pin|LED2_G_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = LED1_R_Pin|LED1_G_Pin|LED1_B_Pin|LED2_R_Pin|LED2_G_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = RESET_STM_GPS_Pin;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = LED2_B_Pin|LED3_R_Pin|STM_pin_EN_SENS_Pin|STM_pin_EN_LED_Pin|
  ...
  GPIO_InitStruct.Pin = STM_pin_EN_Lora_Pin|Lora_RST_Pin|STM_pin_EN_SHT_Pin|STM_pin_EN_W25_Pin|
                        STM_pin_EN_MEM_Pin|CS_SD_Pin|STM_pin_EN_GPS_Pin;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = Alert_mcu_Pin|CardDetect_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = INT_MEMS_Pin|INT_ICM_Pin|INT_BMP_Pin;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
